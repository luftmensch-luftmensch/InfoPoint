\section{Client}
  ...
  \subsection{Analisi del codice sviluppato}
    ...
    \lstinputlisting[language={[POSIX]JAVA}, style=wnumbers, firstlineandnumber=24, lastline=68]{../../client/app/src/main/java/com/infopoint/model/User.java}

    \lstinputlisting[language={[POSIX]JAVA}, style=wnumbers, firstlineandnumber=26, lastline=46]{../../client/app/src/main/java/com/infopoint/model/ArtWork.java}
    ...
    \lstinputlisting[language={[POSIX]JAVA}, style=wnumbers, firstlineandnumber=36, lastline=58]{../../client/app/src/main/java/com/infopoint/model/properties/ArtworkUtil.java}
